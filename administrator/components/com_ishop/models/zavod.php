 ...
 * Ishop model.
 */
class IshopModelZavod extends JModelAdmin
{
	 ...
	 * @since	1.6
	 */
	public function getTable($type = 'Zavod', $prefix = 'IshopTable', $config = array())
	{
	...
	public function getForm($data = array(), $loadData = true)
	{
            ...
            // Get the form.
            $form = $this->loadForm('com_ishop.zavod', 'zavod', array('control' => 'jform', 'load_data' => $loadData));
            if (empty($form)) {
                    return false;
            }
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_ishop.edit.zavod.data', array());
